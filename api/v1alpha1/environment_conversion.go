...
func (src *Environment) ConvertTo(dstRaw conversion.Hub) error {
	...
	if src.Spec.UnstableConfigurationFields != nil {
		if &src.Spec.UnstableConfigurationFields.ClusterType != nil {
		...
		if &src.Spec.UnstableConfigurationFields.KubernetesClusterCredentials != nil {
...
func (dst *Environment) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if src.Spec.Target != nil {
		if &src.Spec.Target.ClusterType != nil {
		...
		if &src.Spec.Target.KubernetesClusterCredentials != nil {
